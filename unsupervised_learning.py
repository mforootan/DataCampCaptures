...
model = model = NMF(n_components = 7)
...
# not correspond to topics (in the case of documents) or to parts of images, 
# when trained on images. Verify this for yourself by inspecting the components 
# of a PCA model fit to the dataset of LED digit images from the previous exercise. 

#  Import PCA
from sklearn.decomposition import PCA

# Create a PCA instance: model
model = model = PCA(n_components=7)
